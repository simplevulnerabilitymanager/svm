...
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "cd '%DirApp%' ; chmod 755 ./enjarify.sh  ; ./enjarify.sh -o '/tmp/EnjarifyReport - %FileApk%_%Timestamp%.jar' '/tmp/%FileApk%_%Timestamp%.apk'"
