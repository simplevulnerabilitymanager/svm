...
:while1
echo Escaneando...
"%~dp0curl.exe" --compressed -g -H "X-Requested-With: Curl Sample" -u %Username%:%Password% %URL% 1> "%TEMP%\qualys_login_%Timestamp%.txt"
