...
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
echo .
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/domains-hosts/certificate_transparency' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
echo .
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/domains-hosts/google_site_web' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
echo .
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/domains-hosts/hackertarget' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
echo .
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/domains-hosts/mx_spf_ip' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
echo .
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/domains-hosts/shodan_hostname' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
echo .
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/domains-hosts/threatcrowd' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
...
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/netblocks-companies/whois_orgs' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"

rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/netblocks-ports/census_2012' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/netblocks-ports/censysio' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"

rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/ports-hosts/migrate_ports' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
...
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'use recon/hosts-ports/shodan_ip' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
rem "%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'run' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
...
"%~dp0plink.exe" -ssh -P 22 -l %Username% -pw %Password% -C %Server% "echo 'set CREATOR SVM' >> '/tmp/recon-ng-script_%Timestamp%.txt'"
